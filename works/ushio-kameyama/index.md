...
<script type="application/ld+json">
{
  ...
  "description": [
    {
      "@value": "『潮』は、社会統計データから生成された仮想の地形を用いて、地理空間に横たわる不可視な流れを考察しようとする取り組み。空間的な地点を位置に、数値を高さに割り当てることで構築される面的な地形は、現実の地表の形状モデルが大気や水の動きを推測するのに役立つように、データが持つ要素の動きを把握することを可能にする。",
      "@language": "ja"
    }
  ],
  "creator": {
  ...
  "mentions": [
    {
      "@type": "Thing",
      "url": "/works/ushio-kameyama/screenshot.jpg"
    },
    {
      "@type": "Thing",
      "url": "/works/ushio-kameyama/screenshot_zoom_0.jpg"
    },
    {
      "@type": "Thing",
      "url": "/works/ushio-kameyama/screenshot_zoom_1.jpg"
    }
  ]
}
</script>
